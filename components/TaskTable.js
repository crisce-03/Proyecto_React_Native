...
function ColHeader({ label, flex = 1 }) {
  return (
    <View className="px-3 py-2" style={{ flex }}>
      <Text className="text-base uppercase tracking-wider opacity-60">
        {label}
      </Text>
    </View>
  );
...
function getDueISO(task) {
  return task?.dueDate || task?.dueAt || null;
}
      ...
      >
        <View className="flex-row items-start justify-between gap-2">
          <View className="flex-1 pr-2">
            ...
            <Text className="text-[12px] opacity-60 mt-0.5">
              ID: {t.id.slice(-6)}
            </Text>
          </View>
          <View className="flex-row gap-2">
            <TouchableOpacity
              onPress={() => onOpenComments?.(t)}
              className="px-2 py-1 rounded-xl bg-gray-200"
            >
              <Text className="text-lg">💬</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => onDelete?.(t.id)}
              className="px-2 py-1 rounded-xl bg-red-500"
            >
        ...
        return (
          ...
          >
            <Cell flex={3}>
              ...
              <Text className="text-[12px] opacity-60">
                ID: {t.id.slice(-6)}
              </Text>
            </Cell>
            <Cell>
              {assignee ? (
                ...
                <Text className="opacity-40 text-base">—</Text>
              )}
            </Cell>
            <Cell>
              <View className="flex-row items-center gap-2">
            ...
            <Cell>
              <TouchableOpacity
                onPress={() => onDelete?.(t.id)}
                className="px-2 py-1 rounded bg-red-500 self-start"
              >
                <Text className="text-base text-white">Eliminar</Text>
              </TouchableOpacity>
            </Cell>
